...
class MatrixOfButtons:
    ...
    def __init__(self,master,frame,n,f_start,var1):
        ...
        for i in range(0,n):
            for j in range(0,n):
                ...
                self.b[i][j] = ttk.Button(frame,image=photo,command=lambda x1=i, y1=j,n=n,matrica=photo_matrix,frame=frame,card_photo=photo,f_start=f_start,var1=var1: self.funkcija(x1,y1,n,matrica,frame,card_photo,f_start,var1)) #***
    ...
    def funkcija(self,i,j,n,photo_matrix,frame,card_photo,f_start,var1):
        global pom_i,pom_j
        global player
        ...
        if (pom_i!=i or pom_j!=j) and ((i,j) in nonmatched): #da ne bi nastao problem ako neko klikne dva puta na isto dugmei ne mozemo ponovo otvarati osvojene kartice
            ...
            if count % 2 == 0: #proveravamo da li su otvorene 2 kartice, ako jesu radimo sledece
                if photo_matrix[i][j]==photo_matrix[pom_i][pom_j]: #ako su uparene
