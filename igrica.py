...
class MatrixOfButtons:
    #master je root
    def __init__(self,master,frame,f_start,var1,var2,var3):
        ...
        self.lbl = tk.Label(frame,text="\tIgra  ZUTI igrac",font=myFont) #prvi na potezu je ZUTI igrac
        self.points_yellow = tk.Label(frame,text = "Zuti: 0",font=myFont) #labela za bodove ZUTOG igraca
        self.points_blue = tk.Label(frame,text = "Plavi: 0",font=myFont) #labela za bodove PLAVOG igraca
        ...
        for i in range(0,self.n):
            for j in range(0,self.n):
                ...
                self.b[i][j] = ttk.Button(frame,image=photo,command=lambda x1=i, y1=j,n=self.n,frame=frame,card_photo=photo,f_start=
        ...
        self.lbl.grid(row = 0,column = (self.n+3),sticky='nsew')
        self.points_yellow.grid(row = 1,column = (self.n+3),sticky='nsew')
        self.points_blue.grid(row = 1,column = (self.n+4),sticky='nsew')
...
def sel(f_start):    
    if var1.get()==1:
        ...
        m = MatrixOfButtons(root,f_one_player,f_start,var1,var2,var3)
    else:
        print (var1.get())
        print("1 vs 1")
        raise_frame(f_two_players)
        m = MatrixOfButtons(root,f_two_players,f_start,var1,var2,var3)
    ...
    def __init__(self,master,var1,var2,var3):
        ...
        class CanvasButton:
            def __init__(self,f_start,canvas,var1,var2,var3):
                ...
                f_start.rb1 = tk.Radiobutton(self.canvas, text="1 vs rac", variable=var1, value=1,indicatoron=0,cursor='heart',bg='LightCyan2',fg='navy',font=myFontBtn)
                canvas.create_window(370, 50,width=100, height=30,
                                            window=f_start.rb1)
                f_start.rb2 = tk.Radiobutton(self.canvas, text="1 vs 1", variable=var1, value=2,indicatoron=0,cursor='heart',bg='LightCyan2',fg='navy',font=myFontBtn)
                ...
                canvas.create_window(426, 130,width=100, height=30,
                                            window=f_start.rb3)
                ...
                canvas.create_window(426, 165,width=100, height=30,
                                            window=f_start.rb4)
                ...
                canvas.create_window(426, 200,width=100, height=30,
                                            window=f_start.rb5)
                ...
                canvas.create_window(426, 275,width=50, height=30,
                                            window=f_start.rb6)
                ...
                canvas.create_window(426, 310,width=50, height=30,
                                            window=f_start.rb7)
                ...
                canvas.create_window(426, 345,width=50, height=30,
                                            window=f_start.rb8)
